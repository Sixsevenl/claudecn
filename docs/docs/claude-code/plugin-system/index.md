...
Claude Code 插件系统概述。本文提供完整的代码示例和终端操作演示。
...
Claude: Claude Code 插件系统概述的核心概念包括...
```
...
response = client.messages.create(
    ...
    max_tokens=1024,
    messages=[{"role": "user", "content": "Claude Code 插件系统概述"}]
)
...
if __name__ == "__main__":
    result = process("Claude Code 插件系统概述")
    print(result)
```
...
tools = [{
    "name": "process",
    "description": "Claude Code 插件系统概述",
    "input_schema": {
        "type": "object",
        "properties": {
            "query": {"type": "string"}
